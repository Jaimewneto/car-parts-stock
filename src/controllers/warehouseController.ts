...
import { warehouseService, CreateWarehouseInput, UpdateWarehouseInput } from '../services/warehouseService';
import { z } from 'zod';
...
export const warehouseController = {
  ...
  async deleteWarehouse(c: Context) {
    try {
      ...
      return c.json({ success: false, error: 'Failed to delete warehouse' }, 500);
    }
  },
};
